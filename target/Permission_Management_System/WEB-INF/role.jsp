...
<div class="userDiv">
    <table  id="userTable" class="table table-bordered">
        ...
        <c:forEach items="${rolePrivilageMessages }" var="rolePrivilageMessage">
            <tr>
                <td>${rolePrivilageMessage.roleid }</td>
                <td>${rolePrivilageMessage.rolename }</td>
                <td>${rolePrivilageMessage.roleinfo }</td>
                <td id="substring"> <c:forEach items="${rolePrivilageMessage.privilages }" var="privilage"> ${privilage.name }&nbsp;</c:forEach></td>
                <td>
